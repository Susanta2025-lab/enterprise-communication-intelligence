...
export const MailboxErrorState = forwardRef<HTMLDivElement, MailboxErrorStateProps>(
  function MailboxErrorState(
    { message, onRetry, retryLabel = "Try again", showDashboardLink = true },
    ref,
  ) {
    return (
      <div
