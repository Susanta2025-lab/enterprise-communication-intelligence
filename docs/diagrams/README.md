...
| File | Represents |
|---|---|
| [`architecture.mmd`](architecture.mmd) | The implemented layered system: client → FastAPI API → analysis workflow → AI-only service / history repositories → `AIProvider` and PostgreSQL |
