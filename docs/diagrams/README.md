...
| [`identity.mmd`](identity.mmd) | Identity classes: Client → Entra External ID / OIDC → JWT → ECI; mailbox delegated OAuth; ECI → Foundry UAMI / Bedrock task role / Key Vault / Secrets Manager; GitHub → OIDC deploy identities; PostgreSQL |
