...
API does not import executor implementations. There is no executor factory and no HTTP execute route. Production workflow composition still injects the fake. The Graph and Gmail writers are available for later account-driven routing.
